...
class RegisterRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return[
            ...
            "ceg_tipus_if" => "A cég típusa mező kitöltése kötelező,ha a Cég mező ki van jelölve",
            "ado_szam_if" => "Az adószám mező kitöltése kötelező,ha a Cég mező ki van jelölve",
            "bankszamlaszam_if" => "A bankszámlaszám megadása kitöltése kötelező,ha a Cég mező ki van jelölve",
